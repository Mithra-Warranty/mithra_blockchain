...
contract Warranty is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    */ 
     ...
     * @dev The following function returns the sale status associated with a warranty card.
       @param tokenId The tokenId of the warranty card whose sale status is to be returned.
    */ 

    function isOutForSale(uint256 tokenId) external view returns (bool) {
        return _outForSale[tokenId];
    }
